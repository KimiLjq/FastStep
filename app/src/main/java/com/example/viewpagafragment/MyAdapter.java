...
public abstract class MyAdapter<T> extends BaseAdapter {
    ...
    public MyAdapter(ArrayList<T> mData, int mLayoutRe){
        this.mData = mData;
        this.mLayoutRes = mLayoutRe;
    }
    ...
    public static class ViewHolder{
        ...
        /**
         * 将item中的组件加入到mVie中以便下次获取就不用再findViewById()
         * @param id
         * @param <T>
         * @return
         */
         ...
         * 设置图片
         */
        public ViewHolder setImageResource(int id,String url){
            View view = getView(id);
            if(view instanceof com.example.viewpagafragment.MyImageView){
                ((com.example.viewpagafragment.MyImageView) view).setImageURL(url);
            }else{
